...
export const useOAuth2Config = () => ({
  env: {
    ...
    NEXT_PUBLIC_GITHUB_SCOPES: process.env.GITHUB_SCOPES || '',
    NEXT_PUBLIC_GITLAB_CLIENT_ID: process.env.GITLAB_CLIENT_ID || '',
    NEXT_PUBLIC_GOOGLE_CLIENT_ID: process.env.GOOGLE_CLIENT_ID || '',
    NEXT_PUBLIC_GOOGLE_SCOPES: process.env.GOOGLE_SCOPES || '',
    ...
    NEXT_PUBLIC_MICROSOFT_SCOPES: process.env.MICROSOFT_SCOPES || '',
