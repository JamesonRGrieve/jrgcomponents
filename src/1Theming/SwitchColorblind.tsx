  ...
  '& .MuiSwitch-thumb': {
    ...
    '&:before': {
      ...
      backgroundImage: `url("data:image/svg+xml,%3Csvg fill='%23${
        theme.palette.mode === 'dark' ? 'FFF' : '000'
      }' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'%3E%3Cg id='SVGRepo_bgCarrier' stroke-width='0'%3E%3C/g%3E%3Cg id='SVGRepo_tracerCarrier' stroke-linecap='round' stroke-linejoin='round'%3E%3C/g%3E%3Cg id='SVGRepo_iconCarrier'%3E%3Cpath d='M23,17a1,1,0,0,1-2,0A9,9,0,0,0,3,17a1,1,0,0,1-2,0,11,11,0,0,1,22,0ZM12,10a7.008,7.008,0,0,0-7,7,1,1,0,0,0,2,0,5,5,0,0,1,10,0,1,1,0,0,0,2,0A7.009,7.009,0,0,0,12,10Zm0,4a3,3,0,0,0-3,3,1,1,0,0,0,2,0,1,1,0,0,1,2,0,1,1,0,0,0,2,0A3,3,0,0,0,12,14Z'%3E%3C/path%3E%3C/g%3E%3C/svg%3E")`,
    },
  },
  '& .MuiSwitch-track': {
    opacity: 1,
...
export default function StyledSwitch() {
  ...
  return (
    <Tooltip title={themeState.colorblind ? 'Switch to Coloured Mode' : 'Switch to Colorblind Mode'}>
      <SwitchThemed
